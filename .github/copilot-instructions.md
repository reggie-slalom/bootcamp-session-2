...
- [UI Guidelines](../docs/ui-guidelines.md) - Design system, color palettes, and accessibility requirements
- [Testing Guidelines](../docs/testing-guidelines.md) - Testing principles, coverage requirements, and best practices
